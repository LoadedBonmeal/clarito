        ...
        .invoke_handler({
            ...
            let inner: Box<tauri::ipc::InvokeHandler<tauri::Wry>> =
                Box::new(tauri::generate_handler![
                    ...
                    commands::d100::preview_d100_xml,
                    commands::d100::export_d100_xml,
                    commands::d101::preview_d101_xml,
                    commands::d101::export_d101_xml,
                    ...
                    commands::gl::lock_period,
                    commands::gl::unlock_period,
