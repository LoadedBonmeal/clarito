/* ----------------------------------------------------------------------
   Mock data — Romanian SRLs and invoices
   ---------------------------------------------------------------------- */
...
const STATUSES = ["validated", "submitted", "pending", "draft", "rejected", "archived"];
...
// build a deterministic invoice list against the active company
const INVOICES_OUT = [
...
const PALETTE_ITEMS = [
  { section: "Acțiuni rapide", items: [
    { ico: "plus",       label: "Factură nouă",                  kbd: "Ctrl N" },
    { ico: "invoiceIn",  label: "Înregistrare factură primită",  kbd: "Ctrl Shift N" },
    { ico: "user",       label: "Adaugă contact (client/furnizor)", kbd: "Ctrl Alt C" },
    { ico: "cloudUp",    label: "Sincronizează cu ANAF acum",     kbd: "F5" },
    { ico: "download",   label: "Descarcă mesaje SPV",            kbd: "Ctrl D" },
  ]},
  { section: "Navigare", items: [
    { ico: "data",       label: "Mergi la: Dashboard",            kbd: "G D" },
    { ico: "invoice",    label: "Mergi la: Facturi emise",        kbd: "G F" },
    { ico: "invoiceIn",  label: "Mergi la: Facturi primite",      kbd: "G P" },
    { ico: "buildings",  label: "Mergi la: Companii administrate", kbd: "G C" },
    { ico: "reports",    label: "Mergi la: Rapoarte & declarații", kbd: "G R" },
  ]},
  { section: "Companie activă", items: [
    { ico: "split",      label: "Schimbă compania activă…",       kbd: "Ctrl K Ctrl C" },
    { ico: "settings",   label: "Setări companie: ACME România SRL", kbd: "" },
    { ico: "anaf",       label: "Verifică certificat SPV",        kbd: "" },
  ]},
];

window.DATA = {
  COMPANIES, CLIENTS, INVOICES_OUT, INVOICES_IN, ANAF_EVENTS, VALIDATION, SAVED_VIEWS, PALETTE_ITEMS, STATUSES,
};
