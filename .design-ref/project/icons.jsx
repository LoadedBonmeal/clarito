/* ----------------------------------------------------------------------
   Icons — flat, stroke-based, Win-business feel.
   All accept { size, color } and use currentColor.
   Render as <Icon name="..." size={18} />
   ---------------------------------------------------------------------- */
...
const Icon = ({ name, size = 16, className = "", style = {} }) => {
  ...
  return <svg {...props}>{ICON_PATHS[name] || ICON_PATHS.box}</svg>;
};
...
const ICON_PATHS = {
  ...
  printer: <><rect x="6" y="3" width="12" height="6" /><rect x="6" y="14" width="12" height="7" /><path d="M3 9h18v6H3z" /><circle cx="17" cy="12" r=".5" fill="currentColor" /></>,
  ...
  help: <><circle cx="12" cy="12" r="9" /><path d="M9.5 10a2.5 2.5 0 015 0c0 1.5-2.5 2-2.5 3.5" /><circle cx="12" cy="17" r=".6" fill="currentColor" stroke="none" /></>,
