...
export function Sidebar() {
  ...
  const NAV: NavGroup[] = [
    { id: "main", sec: null, items: [
      ...
      { key: "oferte", label: t("shell.nav.quotes"), icon: "docText", path: "/quotes", matchPrefix: "/quotes" },
      { key: "comenzi", label: t("shell.nav.orders"), icon: "clipboard", path: "/orders", matchPrefix: "/orders" },
    ...
    { id: "operare", sec: t("shell.nav.groupOperate"), items: [
      ...
      { key: "registru-casa", label: t("shell.nav.bank"), icon: "banknotes", path: "/bank", more: true },
      { key: "import-bancar", label: t("shell.nav.bankImport"), icon: "archive", path: "/bank-import", more: true },
      { key: "dividende", label: t("shell.nav.dividends"), icon: "scale", path: "/dividends", more: true },
      ...
      { key: "bonuri-fiscale", label: t("shell.nav.fiscalReceipts"), icon: "receipt", path: "/fiscal-receipts", more: true },
    ...
    { id: "stocuri", sec: t("shell.nav.groupStock"), items: [
      ...
      { key: "avize", label: t("shell.nav.avize"), icon: "docUp", path: "/avize", matchPrefix: "/avize" },
      { key: "transfer", label: t("shell.nav.stockTransfer"), icon: "swap", path: "/stock-transfer" },
      { key: "gestiuni", label: t("shell.nav.gestiuni"), icon: "archive", path: "/gestiuni" },
      { key: "inventariere", label: t("shell.nav.inventory"), icon: "clipboard", path: "/inventory", more: true },
      { key: "registru-inventar", label: t("shell.nav.inventoryRegister"), icon: "book", path: "/inventory-register", more: true },
      { key: "productie", label: t("shell.nav.productie"), icon: "cog", path: "/productie", more: true },
      { key: "dezmembrari", label: t("shell.nav.dezmembrari"), icon: "scissors", path: "/dezmembrari", matchPrefix: "/dezmembrari", more: true },
    ]},
