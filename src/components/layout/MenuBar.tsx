...
function buildMenus(
  ...
  return {
    "Fișier": [
      ...
      { type: "row", icon: "download",  label: "Exportă SAF-T (D406)…",                                          onClick: () => { void navigate({ to: "/reports", search: { view: "saft" } }); } },
    ...
    "Date": [
      ...
      { type: "sep" },
      { type: "row", icon: "database",  label: "Plan de conturi",            onClick: () => { void navigate({ to: "/accounts" }); } },
    ...
    "Rapoarte": [
      ...
      { type: "row", icon: "reports", label: "D300 — Decont TVA",         onClick: () => { void navigate({ to: "/declarations" }); } },
      { type: "row", icon: "reports", label: "D394 — Livrări/Achiziții",  onClick: () => { void navigate({ to: "/reports", search: { view: "d394" } }); } },
      { type: "row", icon: "reports", label: "D406 — SAF-T",              onClick: () => { void navigate({ to: "/reports", search: { view: "saft" } }); } },
      { type: "sep" },
      { type: "section", label: "Operative" },
      { type: "row", icon: "reports", label: "Jurnal de vânzări",         onClick: () => { void navigate({ to: "/reports", search: { view: "sales-journal" } }); } },
      { type: "row", icon: "reports", label: "Jurnal de cumpărări",       onClick: () => { void navigate({ to: "/reports", search: { view: "purchase-journal" } }); } },
      { type: "row", icon: "reports", label: "Export contabil",           onClick: () => { void navigate({ to: "/reports", search: { view: "accounting-export" } }); } },
