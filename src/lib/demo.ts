...
const HANDLERS: Record<string, (args?: Record<string, unknown>) => unknown> = {
  ...
  general_ledger: () => [
    // 5311 — Casa în lei: opening balance 2 450 RON, 4 entries across 2 days (June 2026).
    {
      accountCode: "5311",
      accountName: "Casa în lei",
      openingDebit: "2450.00",
      openingCredit: "0.00",
      entries: [
        // Day 1: 2026-06-05 — two movements (one receipt, one payment)
        {
          date: "2026-06-05",
          document: "ChP-001",
          explanation: "Încasare numerar factură FACT-2026-0038",
          contra: "4111",
          debit: "1500.00",
          credit: "0.00",
          balance: "3950.00",
        ...
        },
        {
          date: "2026-06-05",
          document: "Disp-021",
          explanation: "Plată avans deplasare angajat",
          contra: "542",
          debit: "0.00",
          credit: "300.00",
          balance: "3650.00",
        ...
        // Day 2: 2026-06-12 — two movements (one receipt, one payment)
        {
          date: "2026-06-12",
          document: "ChP-002",
          explanation: "Încasare numerar factură FACT-2026-0041",
          contra: "4111",
          debit: "800.00",
          credit: "0.00",
          balance: "4450.00",
        ...
        },
        {
          date: "2026-06-12",
          document: "Disp-022",
          explanation: "Plată cheltuieli protocol",
          contra: "623",
          debit: "0.00",
          credit: "150.00",
          balance: "4300.00",
