...
export const D112_FIELDS: LabelDict = {
  ...
  "casaAng": { label: "Casa de sănătate" },
  ...
  "A_9": { label: "Bază CAS", format: "money_lei" },
...
export const D300_FIELDS: LabelDict = {
  ...
  "R1_1": { label: "Rd.1 — Livrări scutite art.294 (intracomunitare / export, categ. Z/K/E) — bază", format: "money_lei" },
  "R5_1": { label: "Rd.5 — Achiziții intracomunitare de bunuri — bază", format: "money_lei" },
  "R5_2": { label: "Rd.5 — Achiziții intracomunitare de bunuri — TVA colectată", format: "money_lei" },
  "R7_1": { label: "Rd.7 — Achiziții intracomunitare de servicii — bază", format: "money_lei" },
  "R7_2": { label: "Rd.7 — Achiziții intracomunitare de servicii — TVA colectată", format: "money_lei" },
  "R7_1_1": { label: "Rd.7 sub-rând — Achiziții servicii intra-UE cotă 21% — bază", format: "money_lei" },
  "R7_1_2": { label: "Rd.7 sub-rând — Achiziții servicii intra-UE cotă 21% — TVA", format: "money_lei" },
  "R9_1": { label: "Rd.9 — Livrări taxabile cotă standard 21% — bază", format: "money_lei" },
  "R9_2": { label: "Rd.9 — Livrări taxabile cotă standard 21% — TVA colectată", format: "money_lei" },
  "R10_1": { label: "Rd.10 — Livrări taxabile cotă redusă 11% — bază", format: "money_lei" },
  "R10_2": { label: "Rd.10 — Livrări taxabile cotă redusă 11% — TVA colectată", format: "money_lei" },
  "R11_1": { label: "Rd.11 — Livrări taxabile cotă redusă 9% — bază", format: "money_lei" },
  "R11_2": { label: "Rd.11 — Livrări taxabile cotă redusă 9% — TVA colectată", format: "money_lei" },
  "R12_1": { label: "Rd.12 — Total taxare inversă domestică (beneficiar) — bază (Σ sub-rânduri)", format: "money_lei" },
  "R12_2": { label: "Rd.12 — Total taxare inversă domestică (beneficiar) — TVA (Σ sub-rânduri)", format: "money_lei" },
  "R12_1_1": { label: "Rd.12 sub-rând — Taxare inversă cotă 21% — bază", format: "money_lei" },
  "R12_1_2": { label: "Rd.12 sub-rând — Taxare inversă cotă 21% — TVA", format: "money_lei" },
  "R12_2_1": { label: "Rd.12 sub-rând — Taxare inversă cotă 11% — bază", format: "money_lei" },
  "R12_2_2": { label: "Rd.12 sub-rând — Taxare inversă cotă 11% — TVA", format: "money_lei" },
  "R13_1": { label: "Rd.13 — Livrări cu taxare inversă (vânzător, art.331) — bază", format: "money_lei" },
  "R16_1": { label: "Rd.16 — Regularizări taxă colectată (cote vechi 19%/5%) — bază", format: "money_lei" },
  "R16_2": { label: "Rd.16 — Regularizări taxă colectată (cote vechi 19%/5%) — TVA", format: "money_lei" },
  "R17_1": { label: "Rd.17 — TOTAL taxă colectată — bază", format: "money_lei" },
  "R17_2": { label: "Rd.17 — TOTAL taxă colectată — TVA", format: "money_lei" },
  "R18_1": { label: "Rd.18 — Deductibil aferent achizițiilor intra-UE de bunuri (=R5) — bază", format: "money_lei" },
  "R18_2": { label: "Rd.18 — Deductibil aferent achizițiilor intra-UE de bunuri (=R5) — TVA", format: "money_lei" },
  "R20_1": { label: "Rd.20 — Deductibil aferent achizițiilor intra-UE de servicii (=R7) — bază", format: "money_lei" },
  "R20_2": { label: "Rd.20 — Deductibil aferent achizițiilor intra-UE de servicii (=R7) — TVA", format: "money_lei" },
  "R20_1_1": { label: "Rd.20 sub-rând — Servicii intra-UE cotă 21% deductibil (=R7_1_1) — bază", format: "money_lei" },
  "R20_1_2": { label: "Rd.20 sub-rând — Servicii intra-UE cotă 21% deductibil — TVA", format: "money_lei" },
  "R22_1": { label: "Rd.22 — Achiziții interne cotă standard 21% deductibil — bază", format: "money_lei" },
  "R22_2": { label: "Rd.22 — Achiziții interne cotă standard 21% deductibil — TVA", format: "money_lei" },
  "R23_1": { label: "Rd.23 — Achiziții interne cotă redusă 11% deductibil — bază", format: "money_lei" },
  "R23_2": { label: "Rd.23 — Achiziții interne cotă redusă 11% deductibil — TVA", format: "money_lei" },
  "R25_1": { label: "Rd.25 — Total deductibil taxare inversă domestică (=R12) — bază", format: "money_lei" },
  "R25_2": { label: "Rd.25 — Total deductibil taxare inversă domestică (=R12) — TVA", format: "money_lei" },
  "R25_1_1": { label: "Rd.25 sub-rând — Taxare inversă cotă 21% deductibil (=R12_1_1) — bază", format: "money_lei" },
  "R25_1_2": { label: "Rd.25 sub-rând — Taxare inversă cotă 21% deductibil (=R12_1_2) — TVA", format: "money_lei" },
  "R25_2_1": { label: "Rd.25 sub-rând — Taxare inversă cotă 11% deductibil (=R12_2_1) — bază", format: "money_lei" },
  "R25_2_2": { label: "Rd.25 sub-rând — Taxare inversă cotă 11% deductibil (=R12_2_2) — TVA", format: "money_lei" },
  "R27_1": { label: "Rd.27 — TOTAL taxă deductibilă — bază", format: "money_lei" },
  "R27_2": { label: "Rd.27 — TOTAL taxă deductibilă — TVA", format: "money_lei" },
  "R28_2": { label: "Rd.31 — Sub-total taxă dedusă (după pro-rata) — TVA", format: "money_lei" },
  "R30_1": { label: "Rd.32/33 — Regularizări taxă dedusă (cote vechi 19%/9%/5%) — bază", format: "money_lei" },
  "R30_2": { label: "Rd.32/33 — Regularizări taxă dedusă (cote vechi 19%/9%/5%) — TVA", format: "money_lei" },
  "R32_2": { label: "Rd.32 — TOTAL taxă dedusă (=R28_2 + R30_2) — TVA", format: "money_lei" },
  "R33_2": { label: "Rd.33 — TVA de recuperat (MAX(R32_2 − R17_2, 0))", format: "money_lei" },
  "R34_2": { label: "Rd.34 — TVA de plată (MAX(R17_2 − R32_2, 0))", format: "money_lei" },
  "R37_2": { label: "Rd.37 — Sold de plată înainte de compensare (=R34_2)", format: "money_lei" },
  "R40_2": { label: "Rd.40 — Sold de recuperat înainte de compensare (=R33_2)", format: "money_lei" },
  "R41_2": { label: "Rd.41 — Sold final de plată (MAX(R37_2 − R40_2, 0))", format: "money_lei" },
  "R42_2": { label: "Rd.42 — Sold final de recuperat (MAX(R40_2 − R37_2, 0))", format: "money_lei" },
};
...
export const D390_FIELDS: LabelDict = {
  ...
  "bazaP": { label: "Total bază achiziții ulterioare operațiunilor triunghiulare (cod P)", format: "money_lei" },
  "bazaS": { label: "Total bază prestări intracomunitare de servicii (cod S)", format: "money_lei" },
  "bazaR": { label: "Total bază achiziții intracomunitare de servicii (cod R)", format: "money_lei" },
  "total_baza": { label: "Total general baze de impozitare", format: "money_lei" },
  "tip": { label: "Tip operațiune (L/T/A/P/S/R)", format: "enum", enumMap: { "L": "Livrări intracomunitare de bunuri", "T": "Livrări triunghiulare", "A": "Achiziții intracomunitare de bunuri", "P": "Achiziții ulterioare op. triunghiulare", "S": "Prestări intracomunitare de servicii", "R": "Achiziții intracomunitare de servicii" } },
...
export const D394_FIELDS: LabelDict = {
  ...
  "cota": { label: "Cotă TVA", format: "enum", enumMap: {  } },
