...
import { AvizePage } from "@/pages/Avize";
...
const productieRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/productie",
...
const paymentInstrumentsRoute = createRoute({
  getParentRoute: () => rootRoute,
...
const avizeRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/avize",
  component: AvizePage,
});

const dezmembrariRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/dezmembrari",
  component: DezmembrariPage,
});

const accrualsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/accruals",
  component: AccrualsPage,
});

const provisionsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/provisions",
